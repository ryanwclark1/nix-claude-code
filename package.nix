...
let
  version = "2.1.114";  # Update this to install a newer version
...
stdenv.mkDerivation rec {
  ...
  meta = with lib; {
    ...
    longDescription = ''
      Claude Code packaged with Node.js 22 LTS for consistent runtime environment.
      This Nix package is automatically updated hourly to provide the latest version.
